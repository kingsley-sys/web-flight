import { IoAirplaneOutline, IoStar } from "react-icons/io5";
...
const Plans = () => {
  ...
  return (
    <div className="flex w-full pt-5 pb-20 md:px-[200px] px-8 flex-col gap-16 justify-center items-center mt-40">
