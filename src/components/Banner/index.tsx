...
const Banner = () => {
	return (
		...
		>
			<div className="w-full max-w-full h-full md:flex-row flex-col flex items-center justify-between px-10 banner z-[2] md:py-0 py-5 text-center">
				...
				<div className="flex md:flex-row flex-col items-center gap-10 md:mb-0 mb-2">
					<input
						...
						className="md:w-[500px] w-full max-w-[400px] border border-slate-400 outline-none px-3 rounded-[10px] py-3"
					/>
